...
- **Zerg / ZTC** — autonomous coding-agent platform and agentic terminal: parallel tool dispatch, background sub-agents, worktree-isolated batch execution, provider routing, live web-mirror observability.
- **Continual validation** — embedded evaluation harnesses for production AI apps, scoring outputs against deterministic state, tool, artifact, browser, and visual oracles.
