...
- **ZergChat / ZergBoard** — agent-native chat/knowledge and project-board apps (Nuxt/Vue, PostgreSQL, Redis, SSE, Tauri) with embedded ZTC agents, multi-workspace RBAC, Slack sync, and adversarially hardened security.
- **Forward-deployed engineering** — org-management, procurement, and resource-planning platform for an aerospace customer with embedded ZTC agents and continual-validation harnesses scoring outputs against deterministic state, tool, artifact, browser, and visual oracles.
- **AI procurement portal** — agent-assisted intake and approval portal piloted with an enterprise customer: grounded vendor research, human-owned approvals, RBAC and separation-of-duties controls.
- **MOBIVOLT test systems** — automated test and hardware-in-the-loop simulation for a $5M+ DOD-funded fuel-cell program: 250+ sensors, 5,000+ hours of testing (C#/.NET, Python/PyQt).
